...
# Model performance has greatly declined as a result of complexity of the data,
# thus we need more layers and more neurones

# Rule of the thusmb for starting number of hidden layers
...
# 3 or more - addition layer can learn complex representations
